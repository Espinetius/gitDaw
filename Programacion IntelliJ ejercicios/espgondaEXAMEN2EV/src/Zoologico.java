...
public class Zoologico extends CentroOcio{
    ...
    public Zoologico(){
        this(1, "holocaracolo", Math.random()*11+10, "madrid", 2000, true, true);
    }
    public Zoologico(int id, String nombre, double entrada, String prov, int constru, boolean delfinario, boolean pinguinos){
        super();
        this.delfinario=delfinario;
